    ...
    <>
      ...
      <div className="relative min-h-screen bg-gradient-to-b from-black/50 to-transparent text-[#f0f0f0] font-mono flex flex-col items-center justify-between p-4">
        ...
        <main className="flex flex-col items-center text-center max-w-2xl z-10">
          <h1 className="text-2xl mb-4 font-bold glow">blog</h1>
          {/* Blog posts list - customizable */}
          <div className="glass rounded-lg p-6">
            <ul className="space-y-2 text-sm">
              <li><Link href="#" className="hover:text-blue-400 transition-colors">[Blog post 1]</Link></li>
              <li><Link href="#" className="hover:text-green-400 transition-colors">[Blog post 2]</Link></li>
              <li><Link href="#" className="hover:text-yellow-400 transition-colors">[Blog post 3]</Link></li>
            </ul>
          </div>
        </main>
